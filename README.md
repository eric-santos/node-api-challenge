...
- middleware can be applied to any endpoint, error handling middleware.

- [x] Describe Middleware?
- code that happens between an endpoint request and the backend.

- [x] Describe a Resource?
- the data coming back from the database.

- [x] What can the API return to help clients know if a request was successful?
- success codes, console.log messages.

- [x] How can we partition our application into sub-applications?
- by creating different routes and sub-routes for each request to an endpoint.
